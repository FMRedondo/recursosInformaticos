...
<div class="wrap">
    ...
    <p class="shadowFrame">
        ...
        <ellipse fill="white" cx="61.128" cy="19.872" rx="49.25" ry="8.916"></ellipse>
      </svg>
    </p>
    <h3>Error 404</h3>
    <p class="description">Página no encontrada</p>
</div>
</body>
<!--
    Error {{ code }}: {{ message }}
